...
$exeSQL=mysqli_query($conn, $SQL) or die (mysqli_connect_error($conn));    
...
while ($arrayp=mysqli_fetch_array($exeSQL))  
	 ...
	 echo "</td>";  echo "<td style='border: 0px'>";  
	 echo "<p><h5>".$arrayp['prodDescripLong']."</h5>"; //display product small description in the array
	 echo "<p><h3 >$".$arrayp['prodPrice']."</h3>";
	 echo "<p><h3 > Remaining product in stock :".$arrayp['prodQuantity']."</h3>";
